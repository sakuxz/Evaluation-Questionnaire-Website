...
const Worry_q1 = require('./worry_q1');
const Worry_q2 = require('./worry_q2');
const Worry_q3 = require('./worry_q3');
const Worry_q4 = require('./worry_q4');
...
var FloatingButton = React.createClass({
  ...
  render: function() {
    ...
    if(this.state.flowAt === 0){
      ...
      form = <Worry_q1 closeQue={this.closeQue} nextFlow={this.nextFlow} />;
    }else if (this.state.flowAt === 3) {
      form = <Worry_q2 closeQue={this.closeQue} nextFlow={this.nextFlow} saveTempData={this.saveTempData} tempData={this.state.tempData} />;
    }else if (this.state.flowAt === 4) {
      form = <Worry_q3 closeQue={this.closeQue} prevFlow={this.prevFlow} nextFlow={this.nextFlow} saveTempData2={this.saveTempData2} tempData2={this.state.tempData2}/>;
    }else if (this.state.flowAt === 5) {
      form = <Worry_q4 closeQue={this.closeQue} prevFlow={this.prevFlow} nextFlow={this.nextFlow} saveTempData3={this.saveTempData3} tempData3={this.state.tempData3} tempData2={this.state.tempData2} tempData={this.state.tempData} />;
    }
