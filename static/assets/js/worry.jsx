...
var FloatingButton = React.createClass({
  ...
  render: function() {
    ...
    if(this.state.flowAt === 0){
      ...
      form = <Worry_q3 closeQue={this.closeQue} prevFlow={this.prevFlow} nextFlow={this.nextFlow} saveTempData2={this.saveTempData2} tempData2={this.state.tempData2} tempData={this.state.tempData} />;
    }
